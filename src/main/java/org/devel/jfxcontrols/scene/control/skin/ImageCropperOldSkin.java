...
import org.devel.jfxcontrols.scene.control.ImageCropperOld;
 ...
 * 
 */
public class ImageCropperOldSkin extends SkinBase<ImageCropperOld> {
	...
	public ImageCropperOldSkin(ImageCropperOld control) {
		super(control);
		createNodes();
		initialize();
